    ...
    <div class="popup_wrpr_inner">
        <div class="popup">
            ...
            <div class="popup_content">
                <img src="<?php echo e(asset('assets/frontend/img/error-pass.png')); ?>" alt="Failed payment icon">
                <h3>Oops!</h3>
            ...
            <div class="popup_btn_wrpr">
                ...
                <div class="popup_btn_wrpr_item">
                    <button type="button" class="btn btn-green" data-action="retry-payment"
                       data-listener="<?php echo e(route('frontend.gifts.send')); ?>">
                        Try again
                    </button>
                </div>
            </div>
...
<?php /**PATH F:\Gitlab Project\atlanta\resources\views/frontend/gifts/partials/popups/payment-failed.blade.php ENDPATH**/ ?>