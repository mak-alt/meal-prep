<div class="popup_wrpr popup-success-filter mobile-full" id="filter-sides-by-tags">
    <div class="popup_wrpr_inner">
        <div class="popup">
            ...
            <div class="filters">
                ...
                <form action="<?php echo e(route('frontend.order-and-menu.sides-sort', $mealNumber)); ?>" method="GET">
                    <?php echo csrf_field(); ?>
            ...
            <div class="popup_btn_wrpr">
                ...
                <div class="popup_btn_wrpr_item">
                    <button type="button" class="btn btn-green" data-action="filter" data-items-wrapper-id="sides">
                        Show results
                    </button>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\atlanta\resources\views/frontend/order-and-menu/partials/popups/filter-sides-by-tags.blade.php ENDPATH**/ ?>