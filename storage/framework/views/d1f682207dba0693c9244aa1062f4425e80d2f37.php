            ...
            <div class="popup_btn_wrpr">
                ...
                <div class="popup_btn_wrpr_item">
                    <button type="button" class="btn btn_red" data-action="submit-confirmation-popup"
                            data-listener="<?php echo e(route('frontend.order-and-menu.meal-creation.discard', $mealNumber)); ?>"
...
<?php /**PATH C:\laragon\www\atlanta\resources\views/frontend/order-and-menu/partials/popups/discard-meal-creation.blade.php ENDPATH**/ ?>