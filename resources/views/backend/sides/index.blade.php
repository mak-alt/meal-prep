...
@section('content')
    <div class="content-wrapper">
        {{ \Diglactic\Breadcrumbs\Breadcrumbs::render('backend.sides.index') }}
                                    ...
                                    <div class="form-group action-group">
                                        <select class="select form-control" id="table-multiple-actions">
                                            ...
                                            <option data-action="delete-multiple"
                                                    data-listener="{{ route('backend.sides.destroy-multiple') }}">
                                                Delete
                                            </option>
                                        </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table_actions_btns">
                                                <a href="{{ route('backend.sides.edit', $meal->id) }}"
                                                   class="btn btn-block btn-primary">
                                                    Edit
                                                </a>
                                                <a href="{{ route('backend.sides.destroy', $meal->id) }}"
