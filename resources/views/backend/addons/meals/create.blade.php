...
@section('content')
    <div class="content-wrapper">
        {{ \Diglactic\Breadcrumbs\Breadcrumbs::render('backend.addons.meals.create') }}
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            <form action="{{ route('backend.addons.meals.store') }}" method="POST"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="price" name="price"
                                                       value="{{ old('price', 10) }}" placeholder="Price..." min="0"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control points__calculatable"
                                                       ...
                                                       value="{{ old('points', 100) }}" placeholder="Points..."
                                                       required>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="fats" name="fats"
                                                       placeholder="Fats..." value="{{ old('fats') }}" min="0"
                                                       required>
