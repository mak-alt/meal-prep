                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            <form action="{{ route('backend.weekly-menu.update', $weeklyMenu->id) }}" method="POST"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                       placeholder="Title..."
                                                       value="{{$weeklyMenu->name ?? ''}}" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="seoTitle" name="seo_title"
                                                       ...
                                                       value="{{ old('seo_title', $weeklyMenu->seo_title ?? '') }}">
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="seo_description" class="form-control"
                                                          ...
                                                          id="seoDescription"
                                                          style="width: 100%; height: 125px; font-size: 16px; line-height: 18px; border: 1px solid #dddddd; color: #495057; padding: 10px;">{{ old('seo_description', $weeklyMenu->seo_description ?? '') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2" autocomplete="off" name="data[meals][]"
                                                    ...
                                                    @foreach($all_meals ?? [] as $meal)
                                                        <option value="{{ $meal->id }}" {{ in_array($meal->id, $weeklyMenu->data['meals'] ?? []) ? 'selected' : '' }}>
                                                            {{ $meal->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2" autocomplete="off" name="data[sides][]"
                                                    ...
                                                    @foreach($all_sides ?? [] as $side)
                                                        <option value="{{ $side->id }}" {{ in_array($side->id, $weeklyMenu->data['sides'] ?? []) ? 'selected' : '' }}>
                                                            {{ $side->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2" autocomplete="off" name="data[other][]"
                                                    ...
                                                    @foreach($other ?? [] as $item)
                                                        <option value="{{ $item->id }}" {{ in_array($item->id, $weeklyMenu->data['other'] ?? []) ? 'selected' : '' }}>
                                                            {{ $item->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" name="status"
                                                           id="status" {{$weeklyMenu->status ? 'checked' : ''}}>
