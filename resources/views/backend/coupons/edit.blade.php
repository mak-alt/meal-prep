...
@section('content')
    <div class="content-wrapper">
        {{ \Diglactic\Breadcrumbs\Breadcrumbs::render('backend.coupons.edit', $coupon) }}
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="coupon_name"
                                                       placeholder="Coupon name..." id="name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input" name="discount_type"
                                                           ...
                                                           value="currency" {{ old('discount_type', $coupon->discount_type) === 'currency' ? 'checked' : '' }} >
                                                    <label class="form-check-label" for="discount-currency">$</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="discount_type"
                                                           id="discount-percent"
                                                           value="percent" {{ old('discount_type', $coupon->discount_type) === 'percent' ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="description"
                                                          placeholder="Description...">{!! old('description', $coupon->description) !!}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <select class="select2" id="users-select" name="users[]"
                                                        data-placeholder="Select users..." multiple
                                                        {{ $couponAllUsers ? 'disabled' : '' }} style="width: 100%;">
                                                    @foreach($users as $user)
                                                        <option
                                                            value="{{ $user->id }}" {{ !$couponAllUsers && in_array($user->id, old('users', $coupon->users()->get()->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                            {{ $user->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
